...
class Hand(object):
    ...
    Test: randomized input
    Output:
    myHand = Hand(11)
    myHand.setDummyHand('kioknojgsyf')
    myHand.update(daikon): False
    print myHand
    fgijkknoosy
    
    myHand = Hand(9)
    myHand.setDummyHand('illmeoodd')
    myHand.update(milk): False
    print myHand
    ddeillmoo
    
    myHand = Hand(11)
    myHand.setDummyHand('eeccceirzxm')
    myHand.update(coffee): False
    print myHand
    ccceeeimrxz
    
    myHand = Hand(9)
    myHand.setDummyHand('mmuptjlmo')
    myHand.update(plum): True
    print myHand
    jmmot